resource "aws_vpc" "main-pub-vpc" {
  cidr_block = "10.0.0.0/16"
  enable_dns_hostnames = true
  enable_dns_support = true

  tags = {
    "Name" = "${var.prefix}-staging--vpc",
    "cliente" = var.client,
    "ambiente" = "staging"
  }
}
...
resource "aws_subnet" "db-subnets" {
  ...
  tags = {
    "Name" = "${var.prefix}-private-subnet-for-db-${count.index+1}",
    "cliente" = var.client,
    "ambiente" = "staging"
  }
}
